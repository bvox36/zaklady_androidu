...
public class FragmentsActivityCompatible extends FragmentActivity implements OnClickListener {

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.fragment_layout_dynamic);
        PocitaciFragmentCompatible newFragment = PocitaciFragmentCompatible.newInstance(0);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.buttonPridat:
                ...
                PocitaciFragmentCompatible newFragment = PocitaciFragmentCompatible.newInstance(n);
                ft.add(R.id.fragmentContainer, newFragment, "PocitaciFragment").commit();
                break;
